...
using LibraryManagement.Web.Menus;
...
[DependsOn(
    ...
    typeof(LibraryManagementWebModule),
    typeof(LibraryManagementApplicationTestModule),
    typeof(LibraryManagementMongoDbTestModule)
)]
public class LibraryManagementWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(LibraryManagementWebModule).Assembly));
        });
    ...
    private static void ConfigureNavigationServices(IServiceCollection services)
    {
        ...
        {
            options.MenuContributors.Add(new LibraryManagementMenuContributor());
        });
    }
}
